...
<li class="{{ $request->segment(1) == 'game' && $request->segment(2) == 'recent' ? 'active' : '' }}">
  <a href="{{ route('game.recent') }}" class="nav-link d-flex align-items-center" target="_self">
    <i data-feather="plus"></i>
    <span>Recently Added</span>
  </a>
</li>
<li class="{{ $request->segment(1) == 'game' && $request->segment(2) == 'top' ? 'active' : '' }}">
  <a href="{{ route('game.top') }}" class="nav-link d-flex align-items-center" target="_self">
    <i data-feather="star"></i>
    <span>Top Games</span>
  </a>
</li>
<li class="{{ $request->segment(1) == 'game' && $request->segment(2) == 'gainer' ? 'active' : '' }}">
  <a href="{{ route('game.gainer') }}" class="nav-link d-flex align-items-center" target="_self">
    <i data-feather="arrow-up"></i>
    <span>Top Gainer</span>
  </a>
</li>
<li class="{{ $request->segment(1) == 'game' && $request->segment(2) == 'loser' ? 'active' : '' }}">
  <a href="{{ route('game.loser') }}" class="nav-link d-flex align-items-center" target="_self">
    <i data-feather="arrow-down"></i>
    <span>Top Loser</span>
  </a>
</li>
<li class="{{ $request->segment(1) == 'game' && $request->segment(2) == 'redflag' ? 'active' : '' }}">
  <a href="{{ route('game.redflag') }}" class="nav-link d-flex align-items-center" target="_self">
    <i data-feather="thumbs-down"></i>
    <span>Red Flag</span>
  </a>
</li>
<li class="{{ $request->segment(1) == 'game' && $request->segment(2) == 'rugpull' ? 'active' : '' }}">
  <a href="{{ route('game.rugpull') }}" class="nav-link d-flex align-items-center" target="_self">
...
<li class="nav-item dropdown {{ $request->segment(1) == 'exchange' && $request->segment(2) == '' ? 'active' : '' }}" data-menu="dropdown">
  ...
  <ul class="dropdown-menu" data-bs-popper="none">
      ...
      <li class="nav-item {{ $request->segment(1) == 'pte' ? 'active' : '' }}">
        <a href="{{ route('privateSale.add') }}" class="dropdown-item d-flex align-items-center">
...
<li class="nav-item {{ $request->segment(1) == 'exchange' && $request->segment(2) == '' ? 'active' : '' }}">
  <a href="{{ route('exchange.index') }}" class="nav-link d-flex align-items-center" target="_self">
    <i data-feather="shopping-cart"></i>
    <span>Exchange</span>
  </a>
</li>
