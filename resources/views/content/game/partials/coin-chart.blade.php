  ...
  <div class="card">
    <div class="card-header d-flex flex-sm-row flex-column justify-content-md-between align-items-start justify-content-start">
      ...
      <div class="d-flex align-items-center flex-wrap mt-sm-0 mt-1">
        <h2 class="fw-bolder mb-0 me-1">₱ {{ $coin['market_data']['current_price']['php'] }}</h2>
    ...
    <div class="card-header d-flex flex-sm-row flex-column justify-content-md-between align-items-start justify-content-start">
      <div class="btn-group py-1" role="group">
        ...
        <label class="btn btn-sm btn-outline-primary" for="market_caps_{{ $chart_name }}">Market Cap</label>
      ...
      <div class="d-flex align-items-center flex-wrap mt-sm-0 mt-1">
        <div class="btn-group py-1" role="group">
          ...
          <label class="btn btn-sm btn-outline-primary" for="7d_{{ $chart_name }}">7d</label>
          ...
          <label class="btn btn-sm btn-outline-primary" for="14d_{{ $chart_name }}">14d</label>
